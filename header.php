    ...
    <div class="header-top-div">
        <div class="header-top-div-in">
            ...
            <div class="contacts">
                ...
                <div class="contact dsp-none"><i class="bi-envelope"></i> <span>info@peakaninternationschool.com</span>
                </div>
                <div class="contact"><i class="bi-telephone"></i> <span>(+234) 807 323 8828
                    </span></div>
            </div>
        </div>
    </div>
