...
<div class="sidenavdiv">
    ...
    <a href="tel:0807 323 8828" title="Call Customer Care">
        <div class="chat-div">
            <div class="icon-div" style="background:#008040;"><i class="bi-telephone-outbound"></i></div>
            <div class="text">0807 323 8828</div>
          <br clear="all" />
        </div>
    </a>
    <a href="https://api.whatsapp.com/send?text=Hello 1stClassic&amp;phone=" target="_blank" title="Whatsapp">
        <div class="chat-div">
            <div class="icon-div" style="background:#25D366;"><i class="bi-whatsapp"></i></div>
            <div class="text">+234-807 323 8828</div>
          <br clear="all" />
        </div>
    </a>
